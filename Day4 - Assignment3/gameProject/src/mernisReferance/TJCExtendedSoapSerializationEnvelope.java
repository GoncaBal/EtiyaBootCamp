...
public class TJCExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(TJCDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new TJCStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static TJCDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static TJCDateTimeConverter dateTimeConverter = new TJCStandardDateTimeConverter();

    public TJCExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public TJCExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new TJCMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=TJCHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,TJCExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=TJCHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
