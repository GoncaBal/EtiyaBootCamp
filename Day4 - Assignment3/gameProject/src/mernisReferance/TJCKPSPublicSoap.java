...
public class TJCKPSPublicSoap
{
    ...
    public TJCKPSPublicSoap(){}

    public TJCKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public TJCKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        TJCExtendedSoapSerializationEnvelope envelope= new TJCExtendedSoapSerializationEnvelope(TJCExtendedSoapSerializationEnvelope.VER11);
