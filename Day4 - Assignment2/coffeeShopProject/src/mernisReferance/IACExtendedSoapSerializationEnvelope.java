...
public class IACExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(IACDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new IACStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static IACDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static IACDateTimeConverter dateTimeConverter = new IACStandardDateTimeConverter();

    public IACExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public IACExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new IACMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=IACHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,IACExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=IACHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
