...
public class IACKPSPublicSoap
{
    ...
    public IACKPSPublicSoap(){}

    public IACKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public IACKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        IACExtendedSoapSerializationEnvelope envelope= new IACExtendedSoapSerializationEnvelope(IACExtendedSoapSerializationEnvelope.VER11);
